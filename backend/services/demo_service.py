...
def populate_demo_db_db(conn: sqlite3.Connection) -> Dict[str, Any]:
    ...
    fornecedores = [
        ...
        (
            "Central Descartáveis & Embalagens",
            "Felipe Moura",
            "(11) 94321-8765",
            "contato@centraldescartaveis.com.br",
            500.0,
        ),
        ("Nova Era Higiene e Limpeza", "Amanda Rocha", "(11) 93211-9988", "contato@novaerahigiene.com.br", 400.0),
        (
            "Papelaria & Escritório Central",
            "Marcos Vinicius",
            "(11) 92110-4455",
        ...
        (
            "Master Distribuição e Atacado",
            "Juliana Pires",
            "(11) 98122-3344",
            "atacado@masterdistribuicao.com.br",
            750.0,
        ),
    ]
    cursor.executemany(
