...
import { BoasVindasView } from './views/BoasVindas'
import ProdutosView from './views/Produtos'
import { FornecedoresView } from './views/Fornecedores'
import { RodadasView } from './views/Rodadas'
import { NecessidadesView } from './views/Necessidades'
import { CotacoesView } from './views/Cotacoes'
import { ComparacaoView } from './views/Comparacao'
import { AlocacaoView } from './views/Alocacao'
import { ResumoView } from './views/Resumo'
