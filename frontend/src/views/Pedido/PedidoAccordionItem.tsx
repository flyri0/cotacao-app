import { Accordion, Badge, Button, Group, Table, Text, ThemeIcon } from '@mantine/core'
import {
  IconCopy,
  IconMail,
  IconPhone,
...
import { PedidoDanfeDocument } from './PedidoDanfeDocument'
  ...
  return (
    ...
    >
      <PedidoDanfeDocument
        pedido={pedido}
        rodadaId={rodadaId}
        rodadaDescricao={rodadaDescricao}
      />
