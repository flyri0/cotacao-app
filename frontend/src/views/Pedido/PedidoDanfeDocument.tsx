import type { PedidoPorFornecedor } from './types'
...
interface PedidoDanfeDocumentProps {
  pedido: PedidoPorFornecedor
  rodadaId?: number | null
  rodadaDescricao?: string
}

export function PedidoDanfeDocument({ pedido, rodadaId, rodadaDescricao }: PedidoDanfeDocumentProps) {
            ...
            <tr>
              <td style={{ width: '65%' }}>
                ...
                <div style={{ fontSize: '8pt', color: '#334155', marginTop: '2pt' }}>
                  Ciclo de Cotação: <b>#{rodadaId} — {rodadaDescricao || 'Cotação'}</b>
                </div>
              </td>
